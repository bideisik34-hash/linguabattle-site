...
HOME = {
 ...
 "ja":{"title":"LinguaBattle — 英単語の意味と例文","metaDesc":"最も紛らわしい英単語を解説：意味、例文、活用形。get、exit、embarrassed など数百語 — そしてアプリのデュエルで定着。","tagline":"最も<span class='g'>紛らわしい</span>英単語","sub":"意味・例文・活用。そしてアプリのデュエルで定着。","search":"🔍 単語を検索…","popular":"単語","all":"すべてのトピック"},
}
